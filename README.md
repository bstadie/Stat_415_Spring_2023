...
| Week 9, Wednesday        | May 24   | Other things you might need to know. <br/> SVM, Kernel Methods. <br/> Bagging. Boosting. Bias/Variance Tradeoff  <br/> h-index. How to be a good parent.                                        | [Bias Variance](https://people.eecs.berkeley.edu/~jegonzal/assets/slides/linear_regression.pdf) <br/>  |
