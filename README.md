...
| Week 5, Monday        | April 24 | Random Forests, Decision Trees   | link 1  |
| Week 5, Wednsday           | April 26 | Deep Learning. Activation, Initialization, Advanced Optimizer | link 1  |
| Week 6, Monday        | May 1 | Convolutional Neural Nets. Batch Norm. Max Pooling   | link 1  |
| Week 6, Wednsday          | May 3    | Black Box Attacks. Interpretability. Integrated Gradients    | link 1  |
| Week 7, Monday        | May 8    | Recurrent Neural Nets, Padding <br/> Cross Validation on Time Series <br/> Autoregressive models, Machine Translaiton   | link 1  |
...
| Week 9, Monday    |  May 17  | Everything else you need to know about. <br/> Pruning. Distillation. Quantization. <br/> SVM, Kernel Methods, Boosing <br/> Bias-Variance tradeoff <br/> Statistics on how to live a good life.  | link 1  |
| Week 9, Wednesday    |  May 17  | Towards AGI. Transformers <br/> RL. How Chat GPT works. <br/> AI scaling laws <br/> Multi-modal data, clip <br/> Can wikipedia help offline RL?                                     | link 1  |
